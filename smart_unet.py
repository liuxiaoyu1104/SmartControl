...
from diffusers.utils import USE_PEFT_BACKEND, BaseOutput, deprecate, logging, scale_lora_layers, unscale_lora_layers,is_torch_version
...
def ca_forward(self):
    def forward(
        ...
        for downsample_block in self.down_blocks:
            ...
            #print(down_block_res_samples 12)
...
def crossattnupblock2d_forward(self):
    def forward(
        hidden_states: torch.FloatTensor,
        res_hidden_states_tuple: Tuple[torch.FloatTensor, ...],
        temb: Optional[torch.FloatTensor] = None,
